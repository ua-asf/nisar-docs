...
The pixel spacing of the GSLC products is always 5 meters in the north direction, but can vary from 2.5 to 40 meters in the east direction, depending on the acquisition mode and frequency. While 40 MHz acquisitions are processed to output 5 × 5 meter pixels for [Frequency A](#nisar-frequencies) GSLC layers, all the other frequencies will have non-square pixels. 

GCOV products always have square pixels, but are posted using larger pixel spacing than the GSLC products. Most of the GCOV products have a pixel spacing of either 10 or 20 meters for [Frequency A](#nisar-frequencies) layers, with [Frequency B](#nisar-frequencies) layers posted to 80 meters.
