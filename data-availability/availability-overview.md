...
NISAR has continually collected L-band data over nearly all global land mass since August 2025. @data-acquisition-extent shows the spatial extent of the collected data. The [NISAR Mission Observation Plan](https://experience.arcgis.com/experience/6052a864cd01459393884a7f751558e3) provides a more detailed, interactive map of NISAR data acquisitions.
...
The NISAR project is committed to generating Level 0-3 data products from all L-band data acquired since the beginning of November 2025. All L-band data products will be available to the public through the Alaska Satellite Facility.

The nominal data release timeline as of March 2026 is described below.
...
After the calibration phase concludes and software improvements are finalized, the NISAR project will begin forward processing of newly-acquired data. Forward processing is targeted to begin by the end of June 2026.

Fully-calibrated Level 0-3 products will be continuously generated from all data acquired from the start of forward processing into the future. This includes data for all areas shown in @data-acquisition-extent and in the [NISAR Mission Observation Plan](https://experience.arcgis.com/experience/6052a864cd01459393884a7f751558e3).

New data will be continuously published to ASF and made publicly available. Level 1-3 products will have a nominal latency of 1-3 days from data acquisition to availability. This will also include the initial public release of L0B RRSD products, which will have a nominal latency of 6-12 hours.

### Sep 2026: Calibrated back processing

After the start of forward processing, the NISAR project will produce calibrated Level 0-3 products from the global backlog of all data collected November 2025 through June 2026. This processing is targeted to begin by the end of September 2026 and complete by the end of December 2026. Data products will be continually published to ASF and made publicly available as they are generated over the course of the processing campaign.
