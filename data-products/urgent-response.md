...
PR products will still be generated at the usual [latency](#ur-latency) for acquisitions flagged for UR processing, so PR products will generally be available a day or two after the UR products become available. UR products are retained in the archive for 30 days, after which only the PR products will be available.
