...
The complex backscatter values of the RSLC are Digital Numbers (DNs) with secondary layer Lookup Tables (LUTs) provided to convert to beta-naught, sigma-naught, and gamma-naught radiometry. These radiometric correction LUTs are defined for the ellipsoid, not for the local terrain. 
